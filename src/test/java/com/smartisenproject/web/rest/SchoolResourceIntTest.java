...
import com.smartisenproject.repository.SchoolRepository;
...
public class SchoolResourceIntTest {
    ...
    private static final String DEFAULT_BUILDINGS = "AAAAAAAAAA";
    private static final String UPDATED_BUILDINGS = "BBBBBBBBBB";
    ...
    public void createSchool() throws Exception {
        ...
        assertThat(testSchool.getBuildings()).isEqualTo(DEFAULT_BUILDINGS);
    }
    ...
    public void getAllSchools() throws Exception {
        ...
        restSchoolMockMvc.perform(get("/api/schools?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].buildings").value(hasItem(DEFAULT_BUILDINGS.toString())));
    }
    ...
    public void getSchool() throws Exception {
        ...
        restSchoolMockMvc.perform(get("/api/schools/{id}", school.getId()))
            ...
            .andExpect(jsonPath("$.buildings").value(DEFAULT_BUILDINGS.toString()));
    }
    ...
    public void updateSchool() throws Exception {
        ...
        assertThat(testSchool.getBuildings()).isEqualTo(UPDATED_BUILDINGS);
    }
